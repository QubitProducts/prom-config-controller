...
// List lists all RuleGroups in the indexer.
func (s *ruleGroupLister) List(selector labels.Selector) (ret []*v1beta1.RuleGroup, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.RuleGroup))
	})
	return ret, err
}
...
// List lists all RuleGroups in the indexer for a given namespace.
func (s ruleGroupNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.RuleGroup, err error) {
...
// Get retrieves the RuleGroup from the indexer for a given namespace and name.
func (s ruleGroupNamespaceLister) Get(name string) (*v1beta1.RuleGroup, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("rulegroup"), name)
	}
	return obj.(*v1beta1.RuleGroup), nil
}
